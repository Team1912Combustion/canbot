...
public class RobotContainer {
  ...
  private final Crusher m_crusher = new Crusher();
  ...
  private final Command m_complexAuto = Autos.complexAuto(m_robotDrive, m_crusher);
  ...
  public RobotContainer() {
    ...
    Shuffleboard.getTab("Crusher").add(m_crusher);
  ...
  private void configureButtonBindings() {
    ...
    m_driverController.circle().onTrue(m_crusher.grabHatchCommand());
    // Release the hatch when the Square button is pressed.
    m_driverController.square().onTrue(m_crusher.releaseHatchCommand());
