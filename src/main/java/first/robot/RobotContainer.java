...
public class RobotContainer {
  ...
  private final Crusher crusherSubsystem = new Crusher();
  ...
  private final Command complexAuto = Autos.complexAuto(robotDrive, crusherSubsystem);
  ...
  public RobotContainer() {
    ...
    SmartDashboard.putData("HatchSubsystem", crusherSubsystem);
  }
  ...
  private void configureButtonBindings() {
    ...
    driverController.eastFace().onTrue(crusherSubsystem.grabHatchCommand());
    // Release the hatch when the west face button is pressed.
    driverController.westFace().onTrue(crusherSubsystem.releaseHatchCommand());
